...
#come si definiscono nu0 e sigma0????
option2 <-list("Mstar0"=3,"Lambda0"=2,"mu0"=mean(data2, na.rm = T),"nu0"=2.5,"sigma0"=40,
             "Adapt_MH_hyp1"=0.7,"Adapt_MH_hyp2"=0.234, "Adapt_MH_power_lim"=10, "k0"=1, "alpha_gamma"=1,"Adapt_MH_var0"=1,
             "beta_gamma"=1, "alpha_lambda"=1, "beta_lambda"=1)
example_GDFMM_sampler(data2,1000,1000,2,seed=123, option=option2)
...
#c'è da guardare bene nu0 e sigma0 come si comportano
option<-list("Mstar0"=2,"Lambda0"=2,"mu0"=mean(dat, na.rm = T),"nu0"=1/2,"sigma0"=0.5,
